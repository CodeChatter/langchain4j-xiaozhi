...
public class RagTest {
    ...
    public void testReadDocument() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("/Users/chatter/development/devBank/llm_data/langchain4j/XiaoZhiYiLiao/src/main/resources/测试.txt");
...
//        List<Document> documents = FileSystemDocumentLoader.loadDocumentsRecursively("E:/knowledge", new TextDocumentParser());
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument(
                "/Users/chatter/Downloads/knowledge/医院信息.pdf",
    ...
    /**
     * token 分词器，计算文本 token 数
     * 使用不同分词器（不同大模型）计算 token 数结果不一样
     */
    @Test
